...
sidebar_position: 8
title: AI Search & GEO
description: Generative Engine Optimization — how to appear in AI Overviews, ChatGPT, Perplexity, and the next wave of AI-driven search surfaces.
keywords: [AI search optimization, GEO, generative engine optimization, AI Overviews, ChatGPT SEO, Perplexity SEO, LLM optimization]
---
...
|---|---|
| [GEO Fundamentals](./geo-fundamentals.md) | How LLMs retrieve and cite content; what GEO means in practice |
...
| [Building Agents for SEO Tasks](./seo-agents.md) | Design agents for audits, GSC analysis, content briefs, and technical triage |
| [Building a WebMCP Layer](./webmcp-implementation.md) | Implementation guide: real code, architecture decisions, token math, production checklist |
| [OC MCP — Live POV](https://omar-corral.com/oc-mcp/) | The complete architecture brief: authorized tool access + scraper defense |
...
**[GEO Fundamentals →](./geo-fundamentals.md)**

---

*Questions? [Get in touch](https://omar-corral.com/#contact) — this space is moving fast and I am happy to discuss what's working.*
