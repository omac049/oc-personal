  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Content Security Policy - Allow data URIs for fonts */}
        <meta 
          httpEquiv="Content-Security-Policy" 
          content="default-src 'self'; script-src 'self' 'unsafe-inline' *.google.com *.googletagmanager.com *.google-analytics.com https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src 'self' data: fonts.gstatic.com; img-src 'self' data: *.google.com *.google-analytics.com *.googletagmanager.com; connect-src 'self' *.google-analytics.com *.google.com *.googletagmanager.com; object-src 'none'; base-uri 'self';"
        />
